...
export class InitSchema1765026302582 implements MigrationInterface {
  name = 'InitSchema1765026302582';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "favorites" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "artists" uuid array NOT NULL DEFAULT '{}', "albums" uuid array NOT NULL DEFAULT '{}', "tracks" uuid array NOT NULL DEFAULT '{}', CONSTRAINT "PK_890818d27523748dd36a4d1bdc8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
