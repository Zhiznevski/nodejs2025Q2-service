...
export class UsersController {
  ...
  @ApiCreatedResponse({ description: 'The user has been successfully created', type: UserResponse })
  ...
  @ApiOkResponse({ description: 'The list of users have been successfully retrieved', type: [UserResponse] })
  ...
  @ApiOkResponse({ description: 'The user has been successfully retrieved', type: UserResponse })
  ...
  @ApiOkResponse({ description: "The user's password has been successfully updated", type: UserResponse })
  @ApiBadRequestResponse({ description: "The id is invalid (not uuid)" })
  @ApiNotFoundResponse({ description: "The id doesn't exist" })
